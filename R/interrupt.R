...
#' @description Function that interrupts the local search.
...
#' @param par_curr The current parameter vector.
#' @param L The set of found local optima.
#' @return A boolean, whether to interrupt or not.

interrupt = function(target, par_curr, L, minimize) {
